    ...
    <main className="site">
      ...
      <section id="contact" className="section contact">
        <div className="contactBox">
          ...
          <div className="contactLinks"><a href="mailto:hello@kramatek.com"><Mail size={18}/> info@kramatek.com</a><a href="tel:+12152856549"><Phone size={18}/> +1 (215) 285-6549</a></div>
        </div>
      </section>
