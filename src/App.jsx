    ...
    <main className="site">
      <header className="header">
        <a className="brand" href="#home">
          <img src="/assets/krama-logo-header.png" alt="KramaTek" />
        </a>
      ...
      <section id="home" className="hero">
        <div className="heroText">
          ...
          <p>
            KramaTek builds AI-powered platforms, automation systems, and data-driven
            digital products that help businesses move faster with clarity and confidence.
          </p>
          ...
          <div className="actions">
            ...
            <a className="secondary" href="#about">About KramaTek</a>
          </div>
        </div>
      ...
      <section id="about" className="section about">
        <div>
          ...
          <h2>Technology with clarity, purpose, and intelligence.</h2>
        </div>

        <p>
          KramaTek is focused on building simple, useful, and scalable technology solutions
          for real-world business problems. We combine AI, automation, data, and digital
          engineering to create systems that are easy to use and ready to grow.
        </p>
      </section>
          ...
          {services.map((s) => {
            ...
            return (
              <article className="card" key={s.title}>
                <Icon className="cardIcon" size={34} />
                <h3>{s.title}</h3>
                <p>{s.text}</p>
              </article>
            );
      ...
      <section id="contact" className="section contact">
        <div className="contactBox">
          ...
          <p>
            Reach out for AI platforms, automation, data products, and digital application development.
          </p>

          <div className="contactLinks">
            <a href="mailto:info@kramatek.com">
              <Mail size={18} /> info@kramatek.com
            </a>
            <a href="tel:+919110767628">
              <Phone size={18} /> +91 (911) 076-7628
            </a>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        © 2026 KramaTek. Ancient Wisdom. Future Intelligence.
      </footer>
    </main>
  );
}