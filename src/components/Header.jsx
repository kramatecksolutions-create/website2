  ...
  return <header className="header clean-header">
    <div className="nav clean-nav">
      ...
      <nav className="desktop-nav clean-links">
        ...
        <div className="nav-group"><a className="nav-main" href="/industries">Industries <ChevronDown size={15}/></a><div className="mega-wrap"><div className="mega industry-mega">{Object.entries(industries).map(([slug,v])=><a key={slug} href={`/industries/${slug}`}><strong>{v.title}</strong><small>{v.description}</small></a>)}</div></div></div>
    ...
    {mobile&&<nav className="mobile-menu"><a href="/">Home</a><a href="/why-kramatek">About Us</a><a href="/services">Services</a><a href="/platform">Solutions</a><a href="/industries">Industries</a><a href="/insights">Insights</a><a href="/contact" className="nav-contact">Contact <span>→</span></a></nav>}
  </header>
}
