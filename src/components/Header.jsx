...
import icon from '../assets/brand/kramatek-icon.png'
      ...
      <nav className="desktop-nav nav-capsule">
        <div className="nav-group">
          <a className="nav-main nav-item-rich" href="/services">
            ...
            <span><small>01</small>Services</span><ChevronDown size={14}/>
          </a>
        ...
        <div className="nav-group">
          <a className="nav-main nav-item-rich" href="/industries">
            ...
            <span><small>02</small>Industries</span><ChevronDown size={14}/>
          </a>
        ...
        <a className="nav-item-rich" href="/platform"><span className="nav-symbol"><Layers3 size={16}/></span><span><small>03</small>Solutions</span></a>
        <a className="nav-item-rich" href="/why-kramatek"><span className="nav-symbol"><Lightbulb size={16}/></span><span><small>04</small>Why KramaTek</span></a>
        <a className="nav-item-rich" href="/insights"><span className="nav-symbol"><BookOpen size={16}/></span><span><small>05</small>Insights</span></a>
      </nav>
