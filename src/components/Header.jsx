...
export default function Header(){
  ...
  return <header className="header clean-header">
    ...
    {mobile&&<nav className="mobile-menu"><a href="/">Home</a><a href="/why-kramatek">About Us</a><a href="/services">Services</a><a href="/platform">Solutions</a><a href="/industries">Industries</a><a href="/insights">Insights</a><a href="/contact">Contact</a></nav>}
  </header>
}
