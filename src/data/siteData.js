import clientSira from '../assets/clients/client-sira.png'
import clientFruges from '../assets/clients/client-fruges.png'
import clientVentley from '../assets/clients/client-ventley.png'
import clientQuanteon from '../assets/clients/client-quanteon.png'
import clientAlphasmart from '../assets/clients/client-alphasmart.png'
import clientTechnodrive from '../assets/clients/client-technodrive.png'

export const clients = [
  {src:clientSira, alt:'SiRA'},
  {src:clientFruges, alt:'Fruges'},
  {src:clientVentley, alt:'Ventley Tech'},
  {src:clientQuanteon, alt:'Quanteon'},
  {src:clientAlphasmart, alt:'Alphasmart Solutions'},
  {src:clientTechnodrive, alt:'Technodrive Software Solutions'}
]
