export const clients = [
  {src:'clients/client-sira.png', alt:'SiRA'},
  {src:'clients/client-fruges.png', alt:'Fruges'},
  {src:'clients/client-ventley.png', alt:'Ventley Tech'},
  {src:'clients/client-quanteon.png', alt:'Quanteon'},
  {src:'clients/client-alphasmart.png', alt:'Alphasmart Solutions'},
  {src:'clients/client-technodrive.png', alt:'Technodrive Software Solutions'}
]
...
export const services = {
  'ai-solutions': {
    ...
    image:'/assets/visuals/ai-solutions.svg',
    capabilities:[
  ...
  'data-engineering': {
    ...
    image:'/assets/visuals/data-engineering.svg',
    capabilities:[
  ...
  'analytics-intelligence': {
    ...
    image:'/assets/visuals/analytics-intelligence.svg',
    capabilities:[
  ...
  'digital-transformation': {
    ...
    image:'/assets/visuals/digital-transformation.svg',
    capabilities:[
  ...
  'staff-augmentation': {
    ...
    image:'/assets/visuals/staff-augmentation.svg',
    capabilities:[
  ...
  'managed-services': {
    ...
    image:'/assets/visuals/managed-services.svg',
    capabilities:[
...
export const industries = {
  government:{title:'Government & Public Sector',description:'Operational intelligence, digital services, safety, automation and decision support for complex public-sector environments.',image:'/assets/visuals/government.svg'},
  telecom:{title:'Telecom',description:'Network intelligence, customer analytics, automation and scalable data platforms for communications organizations.',image:'/assets/visuals/telecom.svg'},
  healthcare:{title:'Healthcare',description:'Connected workflows, secure data, intelligent automation and digital platforms for healthcare operations.',image:'/assets/visuals/healthcare.svg'},
  'financial-services':{title:'Financial Services',description:'Secure data, governed AI, automation, analytics and decision intelligence for high-trust financial environments.',image:'/assets/visuals/financial-services.svg'},
  enterprise:{title:'Enterprise & Digital Business',description:'AI, automation, cloud, data and application engineering for organizations modernizing how they operate and grow.',image:'/assets/visuals/enterprise.svg'}
}

export const insights = [
  {slug:'enterprise-ai-from-chatbots-to-workflows',title:'From chatbot to enterprise AI',category:'AI STRATEGY',summary:'Why AI becomes more valuable when it can securely use enterprise knowledge, tools and workflows.',image:'/assets/visuals/ai-solutions.svg',body:['The first wave of enterprise AI often starts with chat. The next step is connecting models to trusted knowledge, governed tools and real operating workflows.','Architecture matters: retrieval quality, permissions, observability, evaluation and human control determine whether AI remains a demo or becomes dependable enterprise capability.']},
  {slug:'designing-reliable-rag',title:'Designing reliable RAG',category:'GENAI ARCHITECTURE',summary:'The architecture choices that determine retrieval quality, security, evaluation and trust.',image:'/assets/visuals/platform.svg',body:['Reliable RAG is not simply a vector database plus a model. Content quality, chunking, metadata, access control, retrieval strategy and evaluation all shape the user experience.','Teams should measure answer groundedness, retrieval precision, latency and failure modes before expanding to high-value workflows.']},
  {slug:'ai-ready-data-foundation',title:'The AI-ready data foundation',category:'DATA',summary:'Why metadata, quality, lineage and access controls matter before scaling AI workloads.',image:'/assets/visuals/data-engineering.svg',body:['AI magnifies the strengths and weaknesses of the underlying data foundation. Strong metadata, quality controls and ownership create the context AI systems need.','Modern data engineering should make trusted information reusable across analytics, automation and AI—not rebuild a new data path for every use case.']}
]
