...
export const industries={government:{title:'Government & Public Sector',description:'Operational intelligence, digital services, safety, automation and decision support for complex public-sector environments.',image:governmentImage},telecom:{title:'Telecom',description:'Network intelligence, customer analytics, automation and scalable data platforms for communications organizations.',image:telecomImage},healthcare:{title:'Healthcare',description:'Connected workflows, secure data, intelligent automation and digital platforms for healthcare operations.',image:healthcareImage},'financial-services':{title:'Financial Services',description:'Secure data, governed AI, automation, analytics and decision intelligence for high-trust financial environments.',image:financeImage},enterprise:{title:'Enterprise & Digital Business',description:'AI, automation, cloud, data and application engineering for organizations modernizing how they operate and grow.',image:enterpriseImage}}
export const specialImages={platformImage,whyImage,insightsImage,contactImage}
