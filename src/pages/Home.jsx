...
import {ArrowRight,ArrowUpRight,BrainCircuit,Database,ChartNoAxesCombined,CloudCog,UsersRound,Settings2,RadioTower,HeartPulse,Building2} from 'lucide-react'
...
const industryIcons={telecom:RadioTower,healthcare:HeartPulse,'financial-services':Building2,enterprise:Building2}
...
<section className="client-zone client-zone-bottom"><div className="container"><div className="client-title">ORGANIZATIONS WE SUPPORT</div><div className="client-logo-grid">{clients.map((c,i)=><div className="client-logo-card" key={i}><img src={c.image} alt={`${c.name} logo`}/></div>)}</div></div></section>
