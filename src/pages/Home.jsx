...
<section className="client-zone client-zone-bottom"><div className="container"><div className="client-title">ORGANIZATIONS WE SUPPORT</div><div className="client-name-grid">{clients.map((c,i)=><div className="client-name-card" key={i}>{c.name}</div>)}</div></div></section>
