...
export default function Contact() {
  ...
  async function submitContact(e){
    ...
    try{
      ...
      form.reset()
      setStatus('Thank you for reaching out. We will contact you soon regarding your request.')
    }catch(err){
      setStatus('We could not send your message right now. Please try again or email info@kramatek.com.')
  ...
  return <>
    <section className="contact-form-hero">
      <div className="container">
        ...
        <form className="infronex-form" onSubmit={submitContact}>
          ...
          <button type="submit" disabled={submitting}>{submitting?'Sending...':'Submit Message'} <Send size={17}/></button>
